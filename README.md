...
Η προσπάθεια μας είναι να φτιάξουμε ένα δικό μας  παρόμοιο "οικοσύστημα" αποτελούμενο από software και hardware , πάντα με  ανοιχτό και ελεύθερο λογισμικό και υλικό , το οποίο θα μπορούμε να διαχειριστούμε τοπικά και να ελέγξουμε τόσο εμπορικές συσκευές όσο και δικές μας  κατασκευές. Συνεπώς το σύστημά μας δεν θα είναι δεσμευμένο και εξαρτώμενο από εξωτερικές υπηρεσίες καθώς επίσης θα είναι  πλήρως επεκτάσιμο.
...
Στον server αυτό θα εγκαταστήσουμε ανοικτό λογισμικό το οποίο θα εκτελεί όλες τις διαδικασίες του σήματος.
...
Βασική συσκευή του συστήματος αυτού θα είναι ο ηχητικός βοηθός, ο οποίος θα είναι μια συσκευή που θα αναγνωρίζει ομιλία  και μετά την κατάλληλη επεξεργασία θα μπορεί να απαντά στον χρήστη εκτελώντας ταυτόχρονα και   τις εντολές που αυτός θα του δώσει.

Είσαι συσκευή αυτή θα αποτελείται από :
