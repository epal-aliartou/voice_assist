...
-  Υπάρχουν αρκετές λύσεις στο συγκεκριμένο πεδίο . Όμως οι περισσότερες βασίζονται σε **κλειστές εταιρικές λύσεις** και μάλιστα **ιδιαίτερα ακριβές**. Ο χρήστης τους είναι εγκλωβισμένος στην χρήση μόνο συστημάτων της "Εταιρείας-Λύσης", που θα επιλέξει, χωρίς να μπορεί να  συνδυάσει τα καλά διαφόρων συστημάτων. 
